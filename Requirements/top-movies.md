...
| 4   | Movies are currently sorted only by Top Ranking. Add sorting options: alphabetical by title; by release year, newest first; by release year, oldest first. Indicate the current sorting method in the contextual menu.                                                                                                    | [x]  |
