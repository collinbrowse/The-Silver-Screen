...
| #   | Story                                                                                                                                                                                                                                                                                                                     | Done |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- |
| 1   | Our movie list cells are a mess — fix the layout issues. Display poster images in the correct aspect ratio; pin the title and rating near the top of the cell; pin the release year at the bottom; address any constraint warnings. Follow the UI guidelines in the redline: `[Comps/redline.png](../Comps/redline.png)`. | [ ]  |
| 2   | There is laggy scrolling behavior on the main movie feed. Make the changes required to improve performance.                                                                                                                                                                                                               | [ ]  |
| 3   | If the API or network fails, the user is never told. Add error handling on the main view controller to inform the user.                                                                                                                                                                                                   | [ ]  |
