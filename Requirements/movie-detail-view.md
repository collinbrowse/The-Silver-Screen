...
| 5   | Underneath the carousels above, add another carousel with a list of similar movies. In the cell show the poster image, movie name, genres, and release date.                                                                | [ ]  |
| 6   | Underneath the above carousel, if the movie is part of a collection, show a carousel of collections it is in. Each cell should include the poster image and the name of the collection.                                     | [ ]  |
| 7   | Underneath the carousel, create a table listing reviews. This can paginate, so handle pagination. Each cell includes: the reviewer's content, the reviewer's name, their username, and the last updated date of the review. | [ ]  |
